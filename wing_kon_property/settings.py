...
# Departmental Email Settings
ACCOUNTS_EMAIL = env('ACCOUNTS_EMAIL', default=TO_EMAIL)
LEASING_EMAIL = env('LEASING_EMAIL', default=TO_EMAIL)
MAINTENANCE_EMAIL = env('MAINTENANCE_EMAIL', default=TO_EMAIL)
OPERATIONS_EMAIL = env('OPERATIONS_EMAIL', default=TO_EMAIL)
MANAGEMENT_EMAIL = env('MANAGEMENT_EMAIL', default=TO_EMAIL)
HR_EMAIL = env('HR_EMAIL', default=TO_EMAIL)
INFO_EMAIL = env('INFO_EMAIL', default=TO_EMAIL)
CONTRACTS_EMAIL = env('CONTRACTS_EMAIL', default=TO_EMAIL)
BOOKINGS_EMAIL = env('BOOKINGS_EMAIL', default=TO_EMAIL)
UTILITIES_EMAIL = env('UTILITIES_EMAIL', default=TO_EMAIL)
MOVEOUT_EMAIL = env('MOVEOUT_EMAIL', default=TO_EMAIL)
